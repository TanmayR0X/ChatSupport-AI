(function () {
  const api_url = "https://chat-support-ai-tr.vercel.app/api/chat"
  ...
  <span id="chat-close" style="cursor:pointer; font-size:16px; font-weight:600;">X</span>
  </div>
  ...
  <input id="chat-input" type="text" style="flex:1; padding:8px 10px; border:1px solid #d1d5db; border-radius:8px;font-size:13px; outline:none;" placeholder="Type amessage"/>
  <button id="chat-send" style="padding:8px 12px; border:none; background:#000; color:white; border-radius:8px; font-size:13px; cursor:pointer;">send</button>
  </div>
  `
